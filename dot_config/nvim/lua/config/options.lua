...
-- Decrease update time after which the swap file will be written.
...
-- Add vertical line rule at common word wrap widths.
vim.opt.colorcolumn = '81,101,121'

-- Configure tabs and other indentation.
-- The size of an indent in spaces.
vim.opt.shiftwidth = 4
-- The visual width of a real tab character.
vim.opt.tabstop = 4
