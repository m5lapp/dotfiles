-- Fuzzy Finder for files, buffers, LSP etc.
...
return {
  ...
  dependencies = {
    'nvim-lua/plenary.nvim',
    {
      ...
      -- installed/updated. This is only run then, not every time Neovim starts
      -- up.
      build = 'make',
  ...
  config = function()
    ...
    -- searchmany different aspects of Neovim, your workspace, LSP, and more!
    --
    ...
    end, { desc = '[S]earch existing [B]uffers (fuzzy)' })

    -- This runs on LSP attach per buffer (see main LSP attach function in
    -- 'neovim/nvim-lspconfig' config for more info, it is better explained
    -- there). This allows easily switching between pickers if you prefer using
    -- something else!
    vim.api.nvim_create_autocmd('LspAttach', {
      ...
      callback = function(event)
        ...
        -- Jump to the implementation of the word under your cursor. This is
        ...
        -- Jump to the definition of the word under your cursor. This is where a
        -- variable was first declared, or where a function is defined, etc. To
        -- jump back, press <C-t>.
        vim.keymap.set(
          'n',
          'grd',
    ...
    vim.keymap.set('n', '<leader>/', function()
      -- You can pass additional configuration to Telescope to change the theme,
      -- layout, etc.
